...
REPO_URL="${VALA_TEMPLATE_REPO_URL:-https://github.com/JanGalek/vala-library-template.git}"
REPO_REF="${VALA_TEMPLATE_REF:-master}"
GITHUB_REPO="${VALA_TEMPLATE_GITHUB_REPO:-JanGalek/vala-library-template}"
